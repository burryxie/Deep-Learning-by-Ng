...
trainedLinearDecoder = load('STL10Features.mat');
optTheta = trainedLinearDecoder.optTheta;
ZCAWhite = trainedLinearDecoder.ZCAWhite;
meanPatch = trainedLinearDecoder.meanPatch;
